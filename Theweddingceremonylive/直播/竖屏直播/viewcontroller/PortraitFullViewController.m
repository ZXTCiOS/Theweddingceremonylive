...
- (NSString *)getURL{
    ...
    [manager GET:@"http://live.9158.com/Room/GetHotLive_v2?type=1&page=1&lat=0.0&lon=0.0" parameters:nil progress:^(NSProgress * _Nonnull downloadProgress) {
...
- (void)configPlayer{
    ...
    self.liveplayer = [[NELivePlayerController alloc]
                       initWithContentURL:@"http://hdl.9158.com/live/bb09600276c0b71a08e72a30d542d5b8.flv".xd_URL];
