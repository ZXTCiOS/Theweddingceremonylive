...
@interface DemoTableViewController () <DemoTableViewCellDelegate,UITableViewDataSource,UITableViewDelegate>
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell = [[DemoTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellKey];
